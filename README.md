...
> **סקיל (Skill) ל-Cursor** שמבטיח עיצוב נכון של מסמכים בעברית — כולל כיווניות ימין-לשמאל, גופנים תואמים, ופיסוק תקני.

---

## מה זה עושה?

כשמבקשים מ-Cursor לייצר תוכן בעברית — מסמך Word, מצגת PowerPoint, דף HTML או PDF — הסקיל הזה נכנס לפעולה אוטומטית ומוודא:
...
הסקיל יופעל אוטומטית בכל פעם שתבקשו תוכן בעברית.
